...
export const simpleColors = {
  ...
  SIMPLE_RED: 'red',
  SIMPLE_BROWN: 'brown',
  SIMPLE_ORANGE: 'orange',
  SIMPLE_YELLOW: 'yellow',
  SIMPLE_GREEN: 'green',
  SIMPLE_BLUE: 'blue',
  SIMPLE_PURPLE: 'purple',
  SIMPLE_BLACK: 'black',
  SIMPLE_WHITE: 'white',
  SIMPLE_GRAY: 'gray',
};
...
export const complexColorNames = {
  ...
  duskyMidPink: 'dusky mid pink',
  duskyDarkPink: 'dusky dark pink',
  ...
  lightDuskyBluePurple: 'light dusky blue-purple',
  duskyBluePurple: 'dusky blue-purple',
  darkDuskyBluePurple: 'dark dusky blue-purple',
